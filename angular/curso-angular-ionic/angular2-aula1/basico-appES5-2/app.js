(function () {
 ...
 var RandomQuoteComponent2 = Component({
    selector: 'random-quote2',
    template: '<p><em>{{quote.line}}</em> - {{quote.author}}</p>'
  })
    .Class({
      constructor: function () {
        var self = this;
        this.quote = { line: "Carregando...", author: "Angular" };
        setInterval(function () {
          var randomIndex = Math.floor(Math.random() * quotes.length);
          self.quote = quotes[randomIndex];
        }, 2000);
      }
    });
  ...
  var AppComponent = Component({
    ...
    '<random-quote>Loading...</random-quote>'+
    '<random-quote2>Loading...</random-quote2> '
  })
    .Class({
      constructor: function () { }
    });
  ...
  var AppModule = NgModule({
    ...
    declarations: [AppComponent, RandomQuoteComponent, RandomQuoteComponent2],
